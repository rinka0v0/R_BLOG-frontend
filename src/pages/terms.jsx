...
const Terms = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        Rinka built the R_BLOG app as a Free app. This SERVICE is provided by
        Rinka at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at R_BLOG unless otherwise
      ...
      <p>This policy is effective as of 2021-05-01</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at aiueo@expamle.com.
      </p>{" "}
      <p>
